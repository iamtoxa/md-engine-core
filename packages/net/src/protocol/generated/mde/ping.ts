...
static addClientTimeMs(builder:flatbuffers.Builder, clientTimeMs:bigint) {
  builder.addFieldInt64(0, clientTimeMs, BigInt('0'));
}
...
static createPing(builder:flatbuffers.Builder, clientTimeMs:bigint):flatbuffers.Offset {
