...
static createCommand(builder:flatbuffers.Builder, type:number, payloadOffset:flatbuffers.Offset):flatbuffers.Offset {
  Command.startCommand(builder);
  Command.addType(builder, type);
  Command.addPayload(builder, payloadOffset);
